...
<section class="ct-sidebar ct-js-sidebar ct-js-background ct-u-displayTable ct-u-hideAnimateBg" data-bg="<?= base_url(); ?>/image/tampilan/full2-menu.jpg">
    <div class="ct-sidebar-inner">
        <div class="item">
            ...
            <h2 class="ct-u-font2 text-uppercase animated " data-fx="flipInY">SECRET<br>menu</h2>
            <p class="animated" data-fx="fadeIn">Secret sem et enim fringilla<br> luctus.
        ...
        <?php foreach ($jenis as $type) { ?>
            <section class="ct-foodBox">
                <div class="ct-imageBox ct-u-marginTop5 section" id="<?= $type['nama_jenis']; ?>">
                    ...
                    $query   = $builder->getWhere(['secret_jenis_menu_id' => $type['secret_jenis_menu_id']]);
                    $menuFirst = $query->getResult();
                    ?>
                    <?php if ($menuFirst) { ?>
                        <img src="<?= base_url(); ?>/image/secret-menu/<?= $type['slug_jenis']; ?>/<?= $menuFirst[0]->foto; ?>" alt="breakfast" />
                    <?php } ?>
                    ...
                    ?>
                        <li class="ct-foodMenu">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <span class="ptn13 ct-u-font1">
                                        <button class="btn btn-sm btn-button--brown addCart" data-id="<?= $menu->secret_id; ?>">Add To Cart</button>
                                    </span>
                                </div>
                                <div class="clearfix">
                                </div>
