            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <form method="POST" action="<?= base_url(); ?>/admin/meja/save" class="form-horizontal">
                            <?= csrf_field(); ?>
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group label-floating is-empty <?= (array_key_exists('nomor_meja', $error)) ? 'has-error' : ''; ?>">
                                                ...
                                                <input type="number" class="form-control" name="nomor_meja" inputmode="numeric" value="<?= old('nomor_meja') ?>">
