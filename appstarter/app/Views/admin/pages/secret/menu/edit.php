...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <a href="<?= base_url(); ?>/admin/secret-menu/<?= $jenis['slug_jenis']; ?>">
                    ...
                    <div class="card-content">
                        ...
                        <form method="POST" action="/admin/secret-menu/<?= $jenis['secret_jenis_menu_id']; ?>/update/<?= $menu['secret_id']; ?>" class="form-horizontal" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="menu_id" value="<?= $menu['secret_id']; ?>">
                            <div class="row">
                                            ...
                                            <div class="form-group label-floating is-empty">
                                                ...
                                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail">
                                                        <img src="<?= base_url(); ?>/image/secret-menu/<?= $jenis['slug_jenis']; ?>/<?= $menu['foto']; ?>" alt="...">
                                                    </div>
