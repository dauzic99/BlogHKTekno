            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <form method="POST" action="<?= base_url(); ?>/admin/pegawai/update/<?= $user['user_id'] ?>" class="form-horizontal">
                            <?= csrf_field(); ?>
                            <div class="row">
                                <div class="col-sm-12 col-m-12 col-lg-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="selectpicker" data-style="select-with-transition" title="Klik Disini Untuk Memilih Role Pegawai" name="role_id">
